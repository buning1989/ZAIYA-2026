...
export const xiaochenDay1Scenario: GuidedScenario = {
  ...
  steps: [
    ...
    },
    {
      ...
      title: "只喝了一杯奶茶",
      narrative: [
        "小晨中午才起床，没有胃口，只喝了一杯奶茶。在呀 ZÀIYA 在饭点邀请她一起吃饭，小晨回复\u201c不想吃\u201d。在在接受了她的拒绝，没有劝，只是安静地继续吃自己的午饭，并告诉她随时可以加入。",
    ...
    },
    {
      ...
      title: "一起发呆",
      narrative: [
        "傍晚家里因为她起了争执。小晨没有力气开口，也不想再向任何人解释，她什么也没说，只是独自进入了在呀ZAIYA的\u201c一起发呆\u201d。无需发言、无需回应，在在和其他用户的虚拟形象只是安静地待在她身边。看到许多人也只是躺着、坐着、发呆，小晨第一次感到：原来不止我一个人撑不住。",
      ],
    ...
    },
    {
      ...
      narrative: [
        ...
        "小晨点开在呀，把已经睡着的在在叫醒。在在没有让她\u201c别想了\u201d，而是把念头比作一台关不掉的电视，引导她暂时不去看，再把注意力慢慢带回被子、呼吸和身体。对话结束，在在重新躺下，小晨也逐渐回到休息。",
      ],
      narrativeLeads: [
        "夜已经很深",
        "小晨点开在呀",
