...
export const xiaochenDay2Scenario: GuidedScenario = {
  ...
  steps: [
    ...
    },
    {
      ...
      title: "把两周的自己，整理成一份",
      narrative: [
        "中午，妈妈提醒她明天复诊，已经跟学校请了假。请假是为了明天能去医院。缺的还是缺了。",
        "下午状态平稳时，小晨点开\u201c帮我整理\u201d，为明天见王医生做准备。",
        "系统把这两周记录到的东西汇总成一份：睡了几点、吃了几餐、哪几天哭过。没有结论，没有解释。",
        "她在后面补了一句自己最想问的：\u201c我什么时候能回学校上课？\u201d",
        "这份东西交给谁、什么时候交，是她按的。",
      ],
      principles: "叙事重建 × 用户授权 × 结构化临床沟通 × 隐私边界",
      explanation: "让她带去的不只是\u201c我很难受\u201d，而是这两周到底发生过什么。",
      moduleTags: ["organize"],
      demoState: {
        enabled: true,
        now: makeDate("15:30"),
