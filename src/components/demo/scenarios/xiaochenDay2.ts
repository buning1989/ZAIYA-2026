...
export const xiaochenDay2Scenario: GuidedScenario = {
  ...
  steps: [
    ...
    },
    {
      ...
      title: "主动记录自己",
      narrative: [
        "周日起得晚些。起来后，小晨主动打开“记一下”，记下了此刻的情绪，也记下了昨晚的睡眠。",
        "她注意到，昨晚大约在午夜前就睡着了——两周前的这个时候，她还在凌晨一两点瞪着天花板。",
        "记录没有连续天数，也不会因为漏记被判定失败。它只是把散落的状态，轻轻留了下来。",
      ],
      principles: "自我监测 × 睡眠节律可视化",
      explanation: "把弥散的状态变成可以看见的事实，这是改变的第一步。",
      moduleTags: ["record"],
      demoState: {
        enabled: true,
        now: makeDate("10:00"),
    ...
    },
    {
      ...
      title: "把两周的自己，整理成一份",
      narrative: [
        "中午，妈妈提醒她明天复诊、已经跟学校请了假。请假意味着又缺一天课，也意味着离“回去上学”更近一点——这份矛盾，成了她一整天的底色。",
        "下午状态平稳时，小晨主动打开“帮我整理”，为明天和王医生的复诊做准备。",
        "在系统整理好的沟通重点之外，她补上了自己最想问的一句：“我什么时候能回学校上课？”",
        "那条最难开口的敏感记录，默认不会放进去；是她自己，轻轻勾选了它——“让医生知道吧。”",
      ],
    ...
    },
    {
      ...
      title: "写一张只给自己的夸夸卡片",
      narrative: [
        "把给医生的材料整理好、确认下来，小晨没有立刻退出。",
        "她自己进了“夸夸自己”，对着一张空白卡片愣了一会儿，才写下一句。",
        "没有人要求她这么做，也没有人会看到——这是她第一次，主动为自己留下一句肯定。",
